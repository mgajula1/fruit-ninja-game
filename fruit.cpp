...
void fruit_update_position(void){
    //pc.printf("start fruit update position");
    ...
    {   newFruit = (FRUIT*) current->data;
        ...
        //pc.printf("fruit_update_position() finished");
    }
}
